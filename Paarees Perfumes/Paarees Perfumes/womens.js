...
for(let index = 0; index< women_perfumes.length; index++){
    prfmContainer.innerHTML+=`
    <div class="img4">
          <img src="${women_perfumes[index].img}" width="300" height="400">
          <h1 class="name">${women_perfumes[index].title}</h1>
          <p class="price">${women_perfumes[index].price}</p>
          <a href='womens-collection.html?id=${index}' class="btn2">Buy Now</a>
        </div>
